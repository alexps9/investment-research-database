...
<p>{anchor:top_1}</p>
<h3>SpaceX 首日大涨 19% 完成史上最大 IPO——但对 AI 投研真正的看点，是 xAI 借此成为公开市场第一个可交易的前沿 AI 敞口</h3>
<ul>
  <li><b>信号源</b>：<b>SpaceX（纳斯达克：SPCX）</b>（<a href="https://www.reuters.com/business/spacex-stock-gains-historic-ipo-2026-06-12/">路透社</a> · <a href="https://www.cnbc.com/2026/06/12/spacex-spcx-ipo-live-updates.html">CNBC</a>）</li>
</ul>
<callout emoji="💡" background-color="light-orange" border-color="orange">
  <p><b>Insights</b></p>
  <p text-indent="1">"史上最大 IPO 首日大涨"是人尽皆知的标题，对投研没有增量；真正值得算清的是<b>这次上市到底把多少"前沿 AI"放到了可交易的公开市场上，以及它给同行标了什么价</b>。
  <ul>
    <li><b>你买到的 AI 只有约两成：</b>xAI 在今年 2 月并入 SpaceX 时独立估值 <b>2500 亿美元</b>，约占 1.25 万亿合并估值的 20%。按这一比例静态推算，首日收盘约 2.1 万亿市值里，xAI 对应约 <b>4000–4500 亿美元</b>，其余约八成是火箭发射与 Starlink。<b>想借 SPCX 获取纯 xAI 敞口是做不到的——它被卫星与火箭业务大幅稀释，且叠加了马斯克个人风险与航天周期性。</b></li>
    <li><b>但它给前沿 AI 标了第一个公开市场价：</b>xAI 这约 2500–4500 亿美元的隐含估值，低于仍在一级市场的 Anthropic（5 月 $9650 亿）和 OpenAI（约 $7300 亿）——xAI 是三巨头里估值最低、却是唯一已可在二级市场交易的。公众资金第一次有了一个（虽不纯但合法、流动的）前沿 AI 入口。</li>
    <li><b>它是 AI IPO 管线的发令枪：</b>首日 +19% 说明公开市场对前沿 AI 叙事胃口极强，这会前移 Anthropic（其 $65 亿 Series H 被明确称为"上市前最后一轮私募"）、OpenAI 的上市节奏，并为它们的定价提供锚点；同时，xAI 烧钱（去年约 26 亿美元 AI 相关亏损、Colossus 超算）从此装进按季披露的上市公司，公众市场将首次定期看到一家前沿实验室的真实 AI 经济账。</li>
  </ul></p>
</callout>
<p text-indent="1"><b>市场表现：</b><b>SpaceX</b> 于 6 月 12 日在纳斯达克挂牌（代码 <b>SPCX</b>），发行价 <b>135 美元</b>，开盘 <b>150 美元</b>（+11%），盘中高见 <b>176.52 美元</b>，收于约 <b>161 美元</b>、首日涨约 <b>19%</b>；募资 <b>750 亿美元</b>为史上最大 IPO，收盘市值约 <b>2.1 万亿美元</b>，马斯克成为全球首位万亿美元富翁。</p>
<p text-indent="1"><b>xAI 敞口拆解：</b>SpaceX 今年 2 月以全股票方式并入 xAI（Grok 母公司），xAI 当时独立估值 <b>2500 亿美元</b>（其估值轨迹：2025 年 3 月 $1130 亿 → 2026 年 1 月 Series E $2300 亿 → 2 月并购 $2500 亿）。按并购时约 20% 的占比静态推算，IPO 后 xAI 对应市值约 <b>4000–4500 亿美元</b>；确切分部价值需待公司后续分部披露。</p>
<p text-indent="1"><b>同业估值对照：</b>xAI 隐含估值（约 $2500–4500 亿）< OpenAI（约 $7300 亿）< Anthropic（5 月 28 日 Series H 后 <b>$9650 亿</b>，逼近万亿、当前估值最高的 AI 创业公司）。三者中 xAI 估值最低，却是唯一已公开交易的。</p>
<whiteboard type="svg"><svg viewBox="0 0 700 400" xmlns="http://www.w3.org/2000/svg" font-family="PingFang SC, Microsoft YaHei, sans-serif"><rect width="700" height="400" fill="#FFFFFF"/><text x="350" y="36" text-anchor="middle" font-size="20" font-weight="700" fill="#1F2329">三大前沿 AI 实验室估值对比（十亿美元）</text><text x="350" y="60" text-anchor="middle" font-size="13" fill="#8A9099">三者中 xAI 估值最低，却是唯一已可在公开市场交易的</text><line x1="80" y1="320" x2="650" y2="320" stroke="#D0D5DD" stroke-width="1.5"/><rect x="140" y="228" width="100" height="92" rx="4" fill="#E8833A"/><text x="190" y="218" text-anchor="middle" font-size="17" font-weight="700" fill="#C56A28">~$400B</text><text x="190" y="346" text-anchor="middle" font-size="16" font-weight="600" fill="#1F2329">xAI</text><text x="190" y="368" text-anchor="middle" font-size="12" fill="#2A8C5A">已公开交易 · SPCX</text><rect x="320" y="152" width="100" height="168" rx="4" fill="#9AA7B8"/><text x="370" y="142" text-anchor="middle" font-size="17" font-weight="700" fill="#5B6675">$730B</text><text x="370" y="346" text-anchor="middle" font-size="16" font-weight="600" fill="#1F2329">OpenAI</text><text x="370" y="368" text-anchor="middle" font-size="12" fill="#8A9099">私募</text><rect x="500" y="98" width="100" height="222" rx="4" fill="#7286A0"/><text x="550" y="88" text-anchor="middle" font-size="17" font-weight="700" fill="#5B6675">$965B</text><text x="550" y="346" text-anchor="middle" font-size="16" font-weight="600" fill="#1F2329">Anthropic</text><text x="550" y="368" text-anchor="middle" font-size="12" fill="#8A9099">私募</text><text x="350" y="392" text-anchor="middle" font-size="11" fill="#A0A6B0">xAI 为并入 SpaceX 的隐含估值（按并购占比静态测算，区间约 2500–4500 亿美元）</text></svg></whiteboard>
<whiteboard type="svg"><svg viewBox="0 0 700 300" xmlns="http://www.w3.org/2000/svg" font-family="PingFang SC, Microsoft YaHei, sans-serif"><rect width="700" height="300" fill="#FFFFFF"/><text x="350" y="36" text-anchor="middle" font-size="20" font-weight="700" fill="#1F2329">SPCX 约 2.1 万亿美元市值的分部构成（估算）</text><text x="350" y="60" text-anchor="middle" font-size="13" fill="#8A9099">买入 SPCX，真正落到前沿 AI（xAI）的敞口只有约两成</text><rect x="70" y="120" width="448" height="84" rx="4" fill="#9AA7B8"/><rect x="518" y="120" width="112" height="84" rx="4" fill="#E8833A"/><text x="294" y="156" text-anchor="middle" font-size="22" font-weight="700" fill="#FFFFFF">80%</text><text x="294" y="180" text-anchor="middle" font-size="13" fill="#FFFFFF">火箭发射 + Starlink</text><text x="574" y="156" text-anchor="middle" font-size="22" font-weight="700" fill="#FFFFFF">20%</text><text x="574" y="180" text-anchor="middle" font-size="13" fill="#FFFFFF">xAI</text><text x="294" y="238" text-anchor="middle" font-size="13" fill="#5B6675">约 1.7 万亿美元</text><text x="574" y="238" text-anchor="middle" font-size="13" fill="#C56A28">约 4000 亿美元</text></svg></whiteboard>
<p text-indent="1"><em>* 注：股价数据来自路透社、CNBC（6 月 12 日）；xAI / OpenAI / Anthropic 估值来自 CNBC、TechCrunch 等公开报道；xAI 占合并体比例与对应市值为按并购估值的静态测算（非官方分部披露），仅供参考。</em></p>

<hr/>

<p>{anchor:top_2}</p>
<h3>美国政府勒令 Anthropic 全面停用 Fable 5 与 Mythos 5——以国家安全为由的出口管制指令，让一款商用旗舰模型一夜之间对所有客户关停</h3>
<ul>
  <li><b>信号源</b>：<b>Anthropic</b> 官方声明（<a href="https://www.anthropic.com/news/fable-mythos-access">Anthropic 官网</a>）</li>
</ul>
<callout emoji="💡" background-color="light-orange" border-color="orange">
  <p><b>Insights</b></p>
  <p text-indent="1">这是前沿 AI 商业化进程中第一次出现的标志性监管事件：美国政府动用出口管制权限，迫使一家头部实验室把正在服务数亿用户的旗舰模型对<b>全部客户</b>下线，而不只是限制境外使用。<b>它把一个此前停留在讨论层面的尾部风险变成了现实——一款正在产生收入的模型，可以因一纸行政指令在数小时内被关停。</b>三层含义值得投研关注：其一，前沿模型的商业化首次被证明存在"开关级"监管风险，这会进入所有依赖单一模型供应商的应用层公司的风险评估；其二，触发点据 Anthropic 称只是一个范围有限的越狱方法（让模型阅读代码库并找出软件漏洞），而同等能力在 GPT-5.5 等公开模型上同样存在，监管标准的一致性存疑；其三，颇具张力的是，Anthropic 正是本周公开呼吁政府加强 AI 监管的那一家（Amodei 万字长文），如今亲历监管以"重手"落到自己头上，恰好检验了"可问责的监管"与"任意的监管"之间的边界。后续关键观察点：访问能否在 24 至 48 小时内恢复、该先例是否会延伸至 OpenAI 与 Google、以及它对全行业模型发布节奏的寒蝉效应。</p>
</callout>
<p text-indent="1"><b>事件经过：</b><b>Anthropic</b> 于美东时间 6 月 12 日 17:21 收到美国政府指令，后者援引国家安全权限下达出口管制令，要求停止任何外国公民（无论身处美国境内还是境外，包括 Anthropic 自己的外籍员工）对 Fable 5 与 Mythos 5 的访问。由于无法按国籍逐一隔离，净效果是 Anthropic 必须对<b>所有客户</b>关停这两款模型；其余 Anthropic 模型不受影响。</p>
<p text-indent="1"><b>起因与反驳：</b>政府认为存在一种"越狱"方法。Anthropic 审查后表示，该方法只能复现少数此前已知的轻微漏洞，且其他公开模型（包括 OpenAI 的 GPT-5.5）无需任何越狱即可发现同类问题；迄今政府仅提供了口头证据，指向一个范围狭窄、非通用的越狱（本质是让模型读一段代码并修复其中的软件缺陷）。</p>
<p text-indent="1"><b>官方立场：</b>Anthropic 表示遵守这一法律指令并已移除访问，但明确不认同——认为因一个范围有限的潜在越狱就召回一款已部署给数亿人的商用模型并不合理，若此标准推广至全行业，将"实质上叫停所有前沿模型供应商的新模型部署"；公司称正努力尽快恢复访问，并将在 24 小时内披露更多细节。</p>
<p text-indent="1"><em>* 注：内容来自 Anthropic 官方声明，事件仍在发展中（官方称将持续更新）；政府方尚未公开其国家安全关切的具体技术依据。</em></p>
...
<grid>
  ...
  <column width-ratio="0.25">
    ...
    <ul>
      <li>AgentPerf 首个智能体基础设施基准发布，英伟达 GB300 夺冠（<a href="https://anchor.placeholder/card_10">↗</a>）</li>
...
<callout emoji="💡" background-color="light-orange" border-color="orange">
  <p><b>Insights</b></p>
  <p text-indent="1">Google DeepMind 通过孵化器形式将 Gemini Robotics 模型开放给欧洲机器人初创公司，<b>三个月加速期内提供 Gemini Robotics 模型访问权限和 AI 技术栈支持</b>。这是一种典型的"生态圈地"策略——用计算资源和模型访问权换取对机器人应用层的影响力，与 AWS、GCP 对 AI 初创公司的早期绑定模式类似，但目标从云算力下沉到具身 AI 平台层。首批 15 家公司覆盖欧洲，显示头部厂商正从平台层加速锁定具身 AI 生态。</p>
</callout>
...
<p>{anchor:card_10}</p>
<h4>业内首个智能体专项基础设施基准 AgentPerf 发布——首测中英伟达 Blackwell Ultra GB300 夺冠，每兆瓦并发智能体数达 H200 的 20 倍</h4>
<ul>
  <li><b>信号源</b>：<b>Artificial Analysis</b>（基准方）· <b>NVIDIA</b> 官方博客（<a href="https://blogs.nvidia.com/blog/nvidia-blackwell-agentperf-artificial-analysis/">NVIDIA Blog</a>）· <b>Rohan Paul</b>（<a href="https://x.com/rohanpaul_ai/status/2065576558312710584">X · 技术解读</a>）</li>
</ul>
<callout emoji="💡" background-color="light-orange" border-color="orange">
  <p><b>Insights</b></p>
  <p text-indent="1">这条信号的主角其实是基准本身：<b>第三方评测机构 Artificial Analysis 发布了业内首个专为智能体负载设计的基础设施基准 AgentPerf，把衡量 AI 芯片的标尺从"每秒吐多少字"改成"每度电能同时养活多少个智能体"</b>——这正是数据中心在智能体时代算成本时最关心的指标。英伟达 GB300 在首测中夺冠是这套新标尺下的第一个结果，约为上代 20 倍，优势来自整机协同而非单卡峰值。新基准一旦被接受，将成为 AMD、谷歌 TPU 等平台被统一对标的标尺，竞争评价体系正在被重写；单位算力智能体承载量的跃升也会直接拉低 agentic 应用的边际推理成本。</p>
</callout>
<p text-indent="1"><b>基准设计：</b><b>Artificial Analysis</b> 推出的 <b>AgentPerf</b> 核心指标是在严格延迟约束下、每兆瓦功耗可支撑的最大并发 AI 智能体数量，覆盖 5K 至 131K token 超长上下文，综合考量内存、网络、专家路由（MoE 模型内部的请求分发）与延迟，区别于传统的峰值吞吐（tokens/s）测试。</p>
<p text-indent="1"><b>首测结果：</b><b>英伟达 Blackwell Ultra GB300 NVL72</b> 以每兆瓦 <b>61,400</b> 个并发编码智能体登顶，上代 <b>H200</b> 为每兆瓦 <b>2,600</b> 个，差距约 <b>20 倍</b>；优势主要来自 72 颗 GPU 的 NVLink 机架级互联与通信-计算重叠优化，即"整机协同"而非单卡峰值。</p>
