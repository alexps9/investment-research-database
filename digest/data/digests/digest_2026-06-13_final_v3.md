...
<p>{anchor:top_1}</p>
<h3>SpaceX 启动史上最大规模 IPO——融资 750 亿美元、估值 1.75 万亿，因已并入 xAI，这成了公开市场第一次能买到前沿 AI 实验室的敞口</h3>
<ul>
  <li><b>信号源</b>：<b>SpaceX</b> SEC 招股文件（<a href="https://www.reuters.com/business/media-telecom/spacex-plans-raise-75-billion-ipo-135-per-share-source-says-2026-06-03/">路透社</a> · <a href="https://spacenews.com/spacex-to-raise-at-least-75-billion-in-ipo/">SpaceNews</a>）</li>
</ul>
<callout emoji="💡" background-color="light-orange" border-color="orange">
  <p><b>Insights</b></p>
  <p text-indent="1">这桩 IPO 本身是资本市场事件，但对 AI 投研真正的意义在于一个被火箭光环盖住的事实：<b>SpaceX 今年已并入 xAI，于是这次上市等于让公开市场第一次买得到一家前沿 AI 实验室（xAI / Grok）的敞口。</b>过去想投 OpenAI、Anthropic、xAI 这类前沿模型公司，只能走一级市场且份额极难拿到；如今 xAI 被打包进全球最大 IPO，公众资金第一次有了合法、流动的入口——但代价是它和火箭发射、Starlink 卫星宽带捆在一起，纯 AI 敞口被稀释，估值也更难拆清。另一个信号同样关键：招股书披露去年约 26 亿美元亏损主要来自 AI 投入，这把"前沿 AI 是吞金重资产"的现实摆到了公开市场面前——SpaceX 上市后的定价表现，将成为公众市场如何为"高投入、长周期的前沿 AI"定价的第一个真实样本，对所有筹备上市的 AI 公司都有锚定意义。</p>
</callout>
<p text-indent="1"><b>交易要点：</b><b>SpaceX</b> 于 5 月 20 日向 SEC 递交 IPO 招股书（S-1），6 月 3 日更新定价文件，计划以每股 <b>135 美元</b>融资至少 <b>750 亿美元</b>，目标估值超 <b>1.75 万亿美元</b>，登陆纳斯达克——这将是有史以来规模最大的 IPO。利润引擎是 Starlink 卫星宽带（在轨卫星已超 1.2 万颗）。</p>
<p text-indent="1"><b>AI 关联：</b>SpaceX 今年完成与 <b>xAI</b> 的合并，将马斯克旗下的前沿大模型业务（Grok）纳入同一上市主体；招股书披露去年约 <b>26 亿美元</b>亏损主要源于 AI 方向的投入。这意味着投资 SpaceX 股票，本质上也是在为 xAI 的 AI 押注定价。</p>
<p text-indent="1"><em>* 注：S-1 递交于 5 月 20 日、定价更新于 6 月 3 日，金额与估值来自路透社、SpaceNews 及 SEC 公开文件；具体上市日期与最终定价以官方为准。本条因体量与 AI（xAI）关联度上头条，时间节点非 6-13 当日。</em></p>
